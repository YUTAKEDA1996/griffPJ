...
function Result(props) {
  const nutrientNames=["タンパク質","ビタミン","脂質","ミネラル"]
  ...
  <div style={{textAlign:"center"}}>
        <Hidden smUp>
          ...
          <img src="static/logoBlack.png" style={{width: "40vw"}}/>
          <Typography variant="body1" style={{color:"#444",letterSpacing:"1vw",fontWeight:"bold",marginTop:"-1vh"}}>あなたに必要な栄養素</Typography>
          ...
          <div style={{marginTop: "5vh",marginBottom:"5vh",textAlign:"center"}}><Button variant="contained" style={{background:'linear-gradient(45deg, #2196F3 30%, #21CBF3 90%)',margin:"0px 100px 0 100px"}}><Link href="/question"><p　style={{color:"#fff"}}>購入はこちらから</p></Link></Button></div>
